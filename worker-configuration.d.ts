/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: b6aca74163cf3d4bbdfecb6c4a3f1770)
// Runtime types generated with workerd@1.20260708.1 2026-07-14 nodejs_compat
interface __BaseEnv_Env {
	WORKFLOW_RESULT: KVNamespace;
	SERVICE_QUEUE: Queue;
	AI: Ai;
	accountId: "05d28f4d9bcd9c4b42a42c06420cb464";
	OPENCODE_GO_KEY: string;
	GOOGLE_AI_KEY: string;
	HERMES_KEY: string;
	QUERY_WORKFLOW: Workflow<Parameters<import("./src/index").QueryWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "accountId" | "OPENCODE_GO_KEY" | "GOOGLE_AI_KEY" | "HERMES_KEY">> {}
}
